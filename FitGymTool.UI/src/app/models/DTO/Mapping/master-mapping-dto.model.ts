import { AIServiceStatusMappingDTO } from './ai-service-status-mapping-dto.model';
 ...
 * fees duration, payment status, membership status, bug severity mappings, etc.
...
export class MasterMappingDataDto {
  ...
  public aiServiceStatusMappings: AIServiceStatusMappingDTO[] = [];
}
