...
public class MembersServiceTests
{
    ...
    public async Task AddNewMemberAsync_GivenNewMemberDetails_WhenRequestIsFromAdmin_ThenAddMemberSuccessfully()
    {
        ...
        _mockMembersDataManager.Setup(x => x.AddNewMemberAsync(It.IsAny<AddMemberDomain>())).ReturnsAsync(true);
        ...
        // Assert
        Assert.True(result);
        _mockMembersDataManager.Verify(x => x.AddNewMemberAsync(It.IsAny<AddMemberDomain>()), Times.Once);
    }
    ...
    public async Task AddNewMemberAsync_GivenNewMemberDetails_WhenDataManagerFails_ThenReturnFalse()
    {
        ...
        _mockMembersDataManager.Setup(x => x.AddNewMemberAsync(It.IsAny<AddMemberDomain>())).ReturnsAsync(false);
    ...
    public async Task AddNewMemberAsync_GivenInvalidDateValues_WhenValidationFails_ThenThrowInvalidOperationException()
    {
        ...
        _mockMembersDataManager.Verify(x => x.AddNewMemberAsync(It.IsAny<AddMemberDomain>()), Times.Never);
    }
    ...
    public async Task AddNewMemberAsync_GivenNewMemberDetails_WhenDataManagerThrowsException_ThenPropagateException()
    {
        ...
        _mockMembersDataManager.Setup(x => x.AddNewMemberAsync(It.IsAny<AddMemberDomain>())).ThrowsAsync(expectedException);
    ...
    {
        // Arrange
        var mockMembersList = new List<MemberDetailsDomain>();
    ...
    public async Task GetMemberByEmailIdAsync_GivenValidEmail_WhenMemberDoesNotExist_ThenThrowInvalidOperationException()
    {
        ...
        MemberDetailsDomain? mockMemberDetails = null;
    ...
    public async Task UpdateMemberDetailsAsync_GivenValidMemberDetails_WhenUpdateSucceeds_ThenReturnTrue()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMemberDetailsAsync(It.IsAny<UpdateMemberDomain>())).ReturnsAsync(true);
        ...
        // Assert
        Assert.True(result);
        _mockMembersDataManager.Verify(x => x.UpdateMemberDetailsAsync(It.IsAny<UpdateMemberDomain>()), Times.Once);
    }
    ...
    public async Task UpdateMemberDetailsAsync_GivenValidMemberDetails_WhenUpdateFails_ThenReturnFalse()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMemberDetailsAsync(It.IsAny<UpdateMemberDomain>())).ReturnsAsync(false);
    ...
    public async Task UpdateMemberDetailsAsync_GivenValidMemberDetails_WhenDataManagerThrowsException_ThenPropagateException()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMemberDetailsAsync(It.IsAny<UpdateMemberDomain>())).ThrowsAsync(expectedException);
    ...
    public async Task UpdateMembershipStatusAsync_GivenValidMembershipStatusData_WhenUpdateSucceeds_ThenReturnTrue()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMembershipStatusAsync(It.IsAny<UpdateMembershipStatusDomain>())).ReturnsAsync(true);
        ...
        // Assert
        Assert.True(result);
        _mockMembersDataManager.Verify(x => x.UpdateMembershipStatusAsync(It.IsAny<UpdateMembershipStatusDomain>()), Times.Once);
    }
    ...
    public async Task UpdateMembershipStatusAsync_GivenValidMembershipStatusData_WhenUpdateFails_ThenReturnFalse()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMembershipStatusAsync(It.IsAny<UpdateMembershipStatusDomain>())).ReturnsAsync(false);
    ...
    public async Task UpdateMembershipStatusAsync_GivenValidMembershipStatusData_WhenDataManagerThrowsException_ThenPropagateException()
    {
        ...
        _mockMembersDataManager.Setup(x => x.UpdateMembershipStatusAsync(It.IsAny<UpdateMembershipStatusDomain>())).ThrowsAsync(expectedException);
