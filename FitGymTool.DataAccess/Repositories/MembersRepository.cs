// *********************************************************************************
//	<copyright file="MembersRepository.cs" company="Personal">
//		Copyright (c) 2025 Personal
//	</copyright>
// <summary>Class that implements the repository pattern for managing member entities.</summary>
// *********************************************************************************
...
/// <summary>
/// Class that implements the repository pattern for managing member entities.
/// </summary>
/// <typeparam name="TEntity">The entity type class.</typeparam>
/// <param name="sqlDbContext">The SQL DB context.</param>
public class MembersRepository<TEntity>(SqlDbContext sqlDbContext) : IRepository<TEntity> where TEntity : class
{
	/// <summary>
	/// The SQL database context used for data access.
	/// </summary>
	protected readonly SqlDbContext _context = sqlDbContext;
